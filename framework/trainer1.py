...
class TPPO(object):
    def __init__(self, args):
        ...
        if args.sigma_type == 'share':
            ...
            print('State Conditioned Sigmas')
        args.mode = "critic"
    ...
    def save(self, save_path, episode):
        ...
        if not os.path.exists(base_path):
            os.makedirs(base_path)
        model_actor_path = os.path.join(base_path, "actor_" + str(episode) + '_' + time_str + ".pth")
        ...
        torch.save(self.actor.state_dict(), model_critic_path)
